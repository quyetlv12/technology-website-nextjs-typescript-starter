...
const Signup = () => {
  const {handleSubmit, register} = useForm<UserSignUpInterface>()
  ...
  return (
    <div className="lg:flex">
      <div className="lg:w-1/2 xl:max-w-screen-sm">
        ...
        <div className="mt-12 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-3 xl:px-24 xl:max-w-2xl">
          <h2
          ...
          <div className="mt-12">
            ...
            <div>
                ...
                <InputCustom fieldName="username" placeholder="Nhập tên" register={register} />
              </div>
              <div className="mt-8">
                <div className="text-sm font-bold text-gray-700 tracking-wide">
                  Điạ chỉ email
                </div>
                <InputCustom fieldName="email" placeholder="Nhập email" register={register} />
              </div>
              <div className="mt-8">
                ...
                <InputCustom fieldName="password" placeholder="Nhập mật khẩu" type="password" register={register} />
              </div>
              <div className="mt-8">
                <div className="text-sm font-bold text-gray-700 tracking-wide">
                  Nhập lại mật khẩu
                </div>
                <InputCustom fieldName="repassword" placeholder="Nhập lại mật khẩu" type="password" register={register} />
              </div>
              <div className="mt-10">
                <button 
                type="submit"
