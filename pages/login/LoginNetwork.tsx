          ...
          <div className="md:flex w-full">
            ...
            <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
              <div className="text-center mb-10">
                ...
                <p>Vui lòng sử dụng các phương thức dưới đây để tiếp tục</p>
              </div>
              <div>
                <div className="flex -mx-3">
                  <div className="w-full px-3 mb-5">
                    <button
                      className="flex items-center justify-center w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold gap-2"
                      onClick={() => handleLoginByGoogle()}
                    >
                      <FcGoogle size={25} className="bg-white rounded-full" />{" "}
                ...
                <div className="flex -mx-3">
                  <div className="w-full px-3 mb-5">
                    ...
                    >
                      <FaGithubSquare size={25} color="#000" /> Đăng nhập với
                      github
                    </button>
                  </div>
                </div>
