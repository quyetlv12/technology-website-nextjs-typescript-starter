    ...
    return (
        <>
            <div 
             ...
             <a href="#">
                    <Image src={`${BASE_API_URL}${image}`} className="p-8 hover:rounded-t-lg rounded-t-lg hover:scale-110 transition-all " height={200} width={350}/>
                </a>
             </div>
                <div className="px-5 pb-5">
                    <a href="#">
                        <h5 className="text-[1.2rem] font-semibold tracking-tight text-gray-900 dark:text-white">{name}</h5>
                    </a>
