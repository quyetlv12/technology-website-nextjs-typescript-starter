...
const ContactFormBottom:FC<Props> = () => {
    return (
        <section className="text-gray-600 body-font relative mb-36 mt-5 rounded-lg">
            <div className="absolute inset-0 bg-gray-300">
               <img src='https://images.pexels.com/photos/5427862/pexels-photo-5427862.jpeg?auto=compress&cs=tinysrgb&w=1260&dpr=1' className='w-full'/>
            </div>
